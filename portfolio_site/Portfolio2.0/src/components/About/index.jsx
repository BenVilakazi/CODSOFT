          ...
          >
            ...
            >
              <Box sx={{ mb: ["10px", "20px"] }}>
                ...
                <Text variant="small">(preferred "Ben")</Text>
              </Box>
              <Paragraph
                variant="default"
                sx={{
              ...
              >
                I'm a Holberton School alumni & fullstack software developer. I've been creating
                websites for over{" "}
                <span
                  onMouseEnter={() =>
                ...
                stack. Check out my{" "}
                <a
                  href="https://www.linkedin.com/in/ben-vilakazi/"
                  target="_blank"
                  rel="noreferrer"
                >
                  LinkedIn
              ...
              >
                ...
                started doing it as a hobby recently. If you're in learn more,
                check out my{" "}
                <a
                  href="https://www.youtube.com/channel/UCbkycNHyZO2qAr3-zWkEczA"
                  target="_blank"
                  rel="noreferrer"
                  onMouseEnter={() => setMouseText("Oversimplified Programmer")}
                  onMouseLeave={() => setMouseText(null)}
                >
                  YouTube channel
                </a>
